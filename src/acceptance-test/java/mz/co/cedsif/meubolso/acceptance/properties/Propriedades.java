package mz.co.cedsif.meubolso.acceptance.properties;

public class Propriedades {
	public static String BASE_URL = "http://localhost:8080";
	public static String PROJECTURL="/meubolso";
	public static String linkNovoGasto="Adicionar Gasto";
	public static String linkNovoGanho="Adicionar Ganho";
